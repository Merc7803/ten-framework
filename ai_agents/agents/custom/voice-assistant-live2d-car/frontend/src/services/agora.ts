...
import { buildTranscriptMessageId } from "@/lib/chat-session";
  ...
  private handleStreamMessage(streamData: any) {
    try {
      ...
      const message: TranscriptMessage = {
        id: buildTranscriptMessageId(payload, messageId),
        text,
        timestamp,
        isUser,
        confidence:
        ...
        dataType:
          typeof payload?.data_type === "string" ? payload.data_type : undefined,
